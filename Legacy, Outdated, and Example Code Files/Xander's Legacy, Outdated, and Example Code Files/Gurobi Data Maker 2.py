...
# Prepare the data for your unit commitment model
n = 100
...
for i in range(0, 4):  # Cuts range from 0 to 3
    for setting in tweak_settings:
        for j in tweak_settings[setting]:
            # Solve the model
...
results_df.to_csv("solver_tuning_results.csv", index=False)
